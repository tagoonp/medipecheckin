        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Create new content</h6>
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="content-category?uid=<?php echo $uid; ?>&role=<?php echo $role; ?>" class="btn btn-sm btn-neutral">Content category</a>
            </div>
          </div>
          <!-- Card stats -->
            ...
            <div class="card-body pt-0">
              <form class="courseForm" onsubmit="return false;">
                <div class="form-group">
                  <label for="">Title : <i class="fas fa-exclamation-circle text-danger"></i></label>
                  <input type="text" name="txtTitle" id="txtTitle"  class="form-control text-dark" placeholder="Enter content title ...">
                </div>
                ...
                <div class="row">
                  <div class="col-12 col-sm-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="txtCat" id="txtCat">
                        ...
                        <?php
                        $strSQL = "SELECT * FROM rs3x_content_category WHERE 1";
                  ...
                  <div class="col-12 col-sm-4">
                    <div class="form-group">
                      <label for="">Alt : </label>
                      <input type="text" name="txtAlt" id="txtAlt" class="form-control" placeholder="Very short detail ...">
                    </div>
                  </div>
                  <div class="col-12 col-sm-2">
                    <div class="form-group">
  ...
  <script type="text/javascript">
    ...
    $(function(){
      $('.courseForm').submit(function(){
        ...
        var jxr = $.post(conf.api + 'content_manage?stage=create', param, function(){}, 'json')
    ...
    <div class="modal-content">
      ...
      <div class="modal-body pt-0">
        <div class="text-center pb-3">
          ...
          <div class="p-3">
            <p>Create success</p>
            <button type="button" name="button" class="btn btn-primary btn-block"  onclick="window.location = 'page?uid=<?php echo $uid; ?>&role=<?php echo $role; ?>'">OK</button>
          </div>
        </div>
      </div>
    </div>
