        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              ...
              <a href="course-create?uid=<?php echo $uid; ?>&role=<?php echo $role; ?>" class="btn btn-sm btn-neutral">Create new course</a>
            </div>
          </div>
          <!-- Card stats -->
              ...
              <table class="table align-items-center table-flush" id="table-1">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="status">Promote</th>
                    <th scope="col" class="sort" data-sort="status">Enroll</th>
                ...
                <tbody class="list">
                  <?php
                  $strSQL = "SELECT *, a.ID as cid FROM rs3x_course a INNER JOIN rs3x_course_category b ON a.course_category = b.ID WHERE a.course_delete = 'N' ORDER BY a.ID DESC";
                  ...
                  if(($result) && (mysqli_num_rows($result))){
                    while($row = mysqli_fetch_array($result)){
                        ...
                        <tr>
                          ...
                          <td><a href="course-edit?uid=<?php echo $uid; ?>&role=<?php echo $role; ?>&course=<?php echo $row['cid']; ?>"><?php echo $row['course_title']; ?></a></td>
                          <td><?php echo $row['course_cost']. " USD"; ?></td>
                          <td class="text-center">
                            ...
                            if($row['course_pr'] == 'Y'){
                              ...
                              <span class="badge badge-dot mr-4">
                                ...
                                <a class="text-light" href="Javascript:toggleStatus('N', '<?php echo $row['cid']; ?>', 'course_pr')" role="button" >
                              ...
                              <span class="badge badge-dot mr-4">
                                ...
                                <a class="text-light" href="Javascript:toggleStatus('Y', '<?php echo $row['cid']; ?>', 'course_pr')" role="button" >
                                  <i class="fas fa-sync"></i>
                                </a>
                              </span>
                              <?php
                          ...
                          <td class="text-center">
                            <?php
                            if($row['course_enroll'] == 'Y'){
                              ?>
                              <span class="badge badge-dot mr-4">
                                <i class="bg-success"></i>
                                <a class="text-light" href="Javascript:toggleStatus('N', '<?php echo $row['cid']; ?>', 'course_enroll')" role="button" >
                                  <i class="fas fa-sync"></i>
                                </a>
                              </span>
                              <?php
                              ...
                              <span class="badge badge-dot mr-4">
                                <i class="bg-warning"></i>
                                <a class="text-light" href="Javascript:toggleStatus('Y', '<?php echo $row['cid']; ?>', 'course_enroll')" role="button" >
                                  <i class="fas fa-sync"></i>
                                </a>
                              </span>
                              <?php
                          ...
                          <td class="text-center">
                            <?php
                            if($row['course_status'] == 'Y'){
                              ?>
                              <span class="badge badge-dot mr-4">
                                <i class="bg-success"></i>
                                <a class="text-light" href="Javascript:toggleStatus('N', '<?php echo $row['cid']; ?>', 'course_status')" role="button" >
                                  <i class="fas fa-sync"></i>
                                </a>
                              </span>
                              <?php
                          ...
                          <td class="text-right">
                            <a class="btn btn-sm btn-icon-only text-light" href="course-edit?uid=<?php echo $uid; ?>&role=<?php echo $role; ?>&course=<?php echo $row['cid']; ?>" >
