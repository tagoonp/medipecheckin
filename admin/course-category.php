        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Course category</h6>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body pt-0">
              <div class="row">
                <div class="col-10">
                  <input type="text" name="" value="" class="form-control" placeholder="Enter category name ...">
                </div>
                <div class="col-2">
                  <button type="button" name="button" class="btn btn-primary btn-block">Create</button>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <!-- Card header -->
            <div class="card-header border-0">
              <h3 class="mb-0">Course category</h3>
            </div>
            <!-- Light table -->
                ...
                <tbody class="list">
                  ...
                  if(($result) && (mysqli_num_rows($result))){
                    ...
                    while($row = mysqli_fetch_array($result)){
                        ?>
                        <tr>
                          <td style="width: 50px;"><?php echo $c; $c++; ?></td>
